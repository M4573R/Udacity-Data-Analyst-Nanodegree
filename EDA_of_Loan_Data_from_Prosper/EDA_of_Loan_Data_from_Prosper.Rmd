...
setwd('~/Documents/Udacity-Projects/EDA_of_Loan_Data_from_Prosper')
...
```{r DebtToIncomeRatio hist all, echo=TRUE, cache=TRUE, warning=FALSE}
...
```{r year by year Data Prep, echo=FALSE, cache=TRUE}
loan <- loan %>% 
