...
Let's take a glimpse of all the variables. Since I set `stringsAsFactor=FALSE` when loads the data. All the varibles are either numeric or string for now. But to make more sense of the analysis, I may change the class of some variables later.
